                            ...
                            <AnimatePresence mode="wait">
                                {!isSubmitted ? (
                                    ...
                                    >
                                        ...
                                        <Button type="submit" disabled={isLoading} size="sm" className="w-full h-9 md:h-10 rounded-lg font-semibold shadow-sm text-sm">
                                            {isLoading ? 'Sending...' : 'Send Message'} <Send className="ml-2 w-3 h-3" />
                                        </Button>
                                    </motion.form>
                                ) : (
                                    <motion.div
