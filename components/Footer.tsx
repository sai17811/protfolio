            ...
            <div className="container px-4 md:px-6">
                <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    <div className="flex items-center gap-4">
                        <Link href="https://github.com/saidevv" target="_blank" className="p-2 rounded-full hover:bg-secondary transition-colors" aria-label="GitHub">
                            <Github className="w-4 h-4" />
                        </Link>
                        <Link href="https://leetcode.com/u/saidevv" target="_blank" className="p-2 rounded-full hover:bg-secondary transition-colors" aria-label="LeetCode">
